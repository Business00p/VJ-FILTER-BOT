...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002410537785'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002387322192').split()]  # For Multiple Id Use One Space Between Each.
...
AUTH_CHANNELS = [int(channel) for channel in environ.get("AUTH_CHANNELS", "-1002288034723, -1002293560200").split()]

# This Is Force Subscribe Channel, also known as Auth Channel 
auth_channel = environ.get('AUTH_CHANNEL', '-1002288034723 -1002293560200')# give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Filterbot:Filterbot@filterbot.dvztj.mongodb.net/?retryWrites=true&w=majority&appName=Filterbot")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/pubdbdhjd')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/rayaan090')
